...
typedef struct
{
    char                    m_filename[40]; /* file's name by searched */
...
typedef struct
{
    ...
    char                    m_upname[40];   /* update file's name by choosed */
...
typedef struct
{
    ...
    char m_filename[20][64];        /* name to backup */
